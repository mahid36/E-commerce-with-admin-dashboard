...
footer {
  ...
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="https://www.bn.creativeitinstitute.com/logo.png">
      </div>
      <div id="company">
        <h2 class="name">Kumo Fashion</h2>
        <div>Mirpur-10, Dhaka, Bangladesh</div>
        <div>+8801985 369874</div>
        <div><a href="kumofashion@hotmail.com">kumofashion@hotmail.com</a></div>
      </div>
      </div>
    </header>
    @php
