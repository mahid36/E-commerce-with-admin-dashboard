								...
								<form class="row m-0" action="{{ route('customer.update') }}" method="POST" enctype="multipart/form-data">
									...
									<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
										<div class="form-group">
											...
											<input type="text" name="name" class="form-control" placeholder="Dhananjay" value="{{ Auth::guard('customer')->user()->name }}" />
										</div>
									</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
										<div class="form-group">
											...
											<input type="text" name="email" class="form-control" placeholder="dhananjay7@gmail.com" value="{{ Auth::guard('customer')->user()->email }}" />
										</div>
									</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
										<div class="form-group">
											...
											<input type="password" name="current_passwrd" class="form-control" placeholder="Current Password" />
										</div>
									</div>
