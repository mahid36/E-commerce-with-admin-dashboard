                ...
                <div class="d-block border rounded mfliud-bot">
                    <div class="dashboard_author px-2 py-5">
                        <div class="dash_auth_thumb circle p-1 border d-inline-flex mx-auto mb-2">
                            <img src="{{ asset('uploads/customer') }}/{{ Auth::guard('customer')->user()->photo }}" class="img-fluid circle" width="100" alt="" />
                        </div>
                        <div class="dash_caption">
                            <h4 class="fs-md ft-medium mb-0 lh-1">{{ Auth::guard('customer')->user()->name }}</h4>
                            <span class="text-muted smalls">{{ Auth::guard('customer')->user()->country }}</span>
                        </div>
                    </div>
                    ...
                    <form class="row m-0" action="{{ route('customer.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ Auth::guard('customer')->user()->name }}" class="form-control" placeholder="Dhananjay" />
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ Auth::guard('customer')->user()->email }}" name="email" class="form-control" placeholder="dhananjay7@gmail.com" />
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                @if (session('wrong_current'))
                                    <strong class="text-danger">{{ session('wrong_current') }}</strong>
                                @endif
                            </div>
                        </div>
