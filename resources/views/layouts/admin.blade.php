	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="{{ route('add.variant') }}" class="nav-link">Add Variant</a>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="{{ route('orders') }}" r>
                ...
                <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-es" title="es" id="es"></i> <span class="ml-1"> Spanish </span></a>
						...
						<li class="nav-item dropdown nav-profile">
							<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img src="https://placeholder.co/80x80" alt="">
                            @else
									...
									<ul class="profile-nav p-0 pt-3">
										...
										<li class="nav-item">
                                            <form method="POST" action="{{ route('logout') }}">
                                              @csrf
											<button type="submit" class="nav-link focus:outline-none focus:ring-0 border-0 bg-transparent">
