                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="javascript:void(0);">
                                                    <img src="{{ asset('uploads/category') }}/{{ $Category->category_image }}" width= 30 alt="">
                                    ...
                                    <div class="product_grid row">
                                        ...
                                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                            <div class="text-left mfliud">
                                                <div class="elso_titl"><span class="small">{{ $top->rel_to_product->rel_to_category->category_name }}</span></div>
                                                <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="{{ route('product.details', $top->rel_to_product->slug) }}">{{ $top->rel_to_product->product_name }}</a></h5>
                                                <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                                    @php
                                                        $total_review = App\Models\OrderProduct::where('product_id',$top->product_id)
                                                        ->whereNotNull('review')->count();
                                                        $total_stars = App\Models\OrderProduct::where('product_id',$top->product_id)
                                                        ->whereNotNull('review')->sum('rating');
                                                        $avg =0;
                                                        if($total_review ==0){
                                                            $avg =0;
                                                        }
                                                ...
                                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">&#2547;{{ $top->rel_to_product->rel_to_inv->first()->price }}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                ...
                                <div class="ftr-content">
                                    ...
                                    <div class="product_grid row">
                                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{asset('frontend_asset')}}/img/shop/4.png" alt="..."></a>
                                            </div>
                                        </div>
                                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                            <div class="text-left mfliud">
                                    ...
                                    <div class="product_grid row">
                                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{asset('frontend_asset')}}/img/shop/5.png" alt="..."></a>
                                            </div>
                                        </div>
                                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                            <div class="text-left mfliud">
                                    ...
                                    <div class="product_grid row">
                                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{asset('frontend_asset')}}/img/shop/6.png" alt="..."></a>
                                            </div>
                                        </div>
                                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                            <div class="text-left mfliud">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                ...
                                <div class="ftr-content">
                                    ...
                                    <div class="product_grid row">
                                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{asset('uploads/product/preview')}}/{{ $recent->preview }}" alt="..."></a>
                                            </div>
                                        </div>
                                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                            <div class="text-left mfliud">
                                                ...
                                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">&#2547;{{ optional($recent->rel_to_inv->first())->price }}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                     @endforeach
